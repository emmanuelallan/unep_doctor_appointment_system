                    ...
                    <table class="border-separate border border-slate-400 table-fixed w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border border-slate-300 py-2">{{ __('Age') }}</th>
                                <th class="border border-slate-300 py-2">{{ __('Symptoms') }}</th>
                        ...
                        <tbody>
                            @foreach ($patients as $patient)
                                <tr>
                                    <td class="border border-slate-300 py-3 px-3">{{ $patient->first_name }} {{ $patient->last_name }}</td>
                                    <td class="border border-slate-300 py-3 px-3">{{ $patient->age }}</td>
                                    <td class="border border-slate-300 py-3 px-3">{{ $patient->symptoms }}</td>
                                    <td class="border border-slate-300 py-3 px-3">{{ $patient->phone }}</td>
                                    <td class="flex items-center gap-4 justify-center border border-slate-300 py-3 px-3">
                                        ...
                                        <a href="{{ route('patients.edit', $patient) }}" class="inline-flex items-center px-4 py-2 bg-indigo-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
